...
//-----------------------------------------------------------
int menu(void) //функция содеражщая меню
{
	char s[80];  int c;
	cout << endl;
	...
	cout << "7. Элемент x в начало" << endl;
	cout << "8. Выход" << endl;
	cout << endl;
	do
	{
...
void addXBegin(int x, Address**phead, Address** plast) // добавляем элемент x в начало
{
	Address* p = *phead;
	Address* e = new  Address();
	snprintf(e->name, NAME_SIZE, "%d", x); // вставляем в ячейку
