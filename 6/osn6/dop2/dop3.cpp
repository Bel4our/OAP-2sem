...
void sumpos5(list*); //функция подсчета суммы положительных чисел кратных 5
...
int main()
{
    ...
    do
    {
        ...
        case 6:
            ...
            break;
        case 7:
            sumpos5(first);	// вычисление произведения
            break;
        }
    } while (choice != 8);
    return 0;
...
void sumpos5(list* p)  // Подсчет суммы положительных чисел кратных 5  
{
    int sum = 0;
    if (p == NULL)
        cout << "Список пуст" << endl;
    else
    {
        ...
        if (sum > 0)
            ...
            cout << "Положительных чисел кратных 5 - нет" << endl;
    }
}
